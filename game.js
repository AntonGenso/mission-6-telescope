...
function setupLevel(idx) {
    ...
    // Auto-clear lines every 5 levels logic
...
window.addEventListener('orientationchange', function () {
    // On orientationchange, dimensions sometimes update after a tick.
    // Resize twice to catch both before and after the layout settles.
    resizeRenderer();
